...
<script>
		$(function() {
			...
			$("#city").change(function() {
				$("#pin_code").load("text/city/" + $(this).val() + ".txt");
			});
    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="consignment1.php">Consignment</a></li>
            ...
            <div class="card card-5">
                <div class="card-heading">
                    ...
                    <div class="form-row">
                            ...
                            <div class="value">
                                <p style="color: red;"><?php echo $_GET['str'];	?></p>
                            </div>
                        </div>
					<div class="form-row">
                        <div class="name">Address Line 1</div>
					...
					<div class="form-row">
                        ...
                        <div class="value">
                            <div class="input-group">
                                <input class="input--style-5" type="text" name="Pincode" onchange="validate1('pin_code',this.value,document.getElementById('city').value)" value="<?php echo $pin; ?>" required><div id="pin_code"></div>
                            </div>
                        </div>
                    </div>
					<div>
