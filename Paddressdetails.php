<?php
	...
	$addline1=$row['add_line_1'];
	$addline2=$row['add_line_2'];
	$city=$row['city'];
    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="service.html">Shipping</a></li>
					...
					<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="addl_1" value="<?php echo $addline1; ?>" required>
                                </div>
                            </div>
                        </div>
					<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="addl_2" value="<?php echo $addline2; ?>" required>
                                </div>
                            </div>
                        </div>
					<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="City" value="<?php echo $city; ?>" required>
                                </div>
                            </div>
                        </div>
					<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="State" value="<?php echo $state; ?>" required>
                                </div>
                            </div>
                    </div>
					<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="Country" value="<?php echo $cou; ?>" required>
                                </div>
                            </div>
                    </div>
					<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="Pincode" onchange="validate('pin_code',this.value)" required value="<?php echo $pin; ?>" required><div id='pin_code'></div>
                                </div>
                            </div>
                        </div>
					<div>
