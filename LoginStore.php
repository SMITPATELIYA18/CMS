    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="active"><a href="LoginStore.php" ><i class="fa fa-lock" aria-hidden="true"></i> Login</a></li>
                ...
                <div class="card-body">
                    <form method="POST" action="login.php">
						<div class="form-row">
                            <div class="value">
                                <div class="input-group">
                                    <p style="align:center; color:red;"><?php echo $_GET['str']; ?></p>
                                </div>
                            </div>
                        </div>
						<div class="form-row p-t-20">
                            ...
                            <div class="p-t-15">
                                <label class="radio-container m-r-55">Consumer
                                    <input type="radio" checked="checked" name="log" value="Consumer">
                                    <span class="checkmark"></span>
                                </label>
								<label class="radio-container m-r-55">Staff
                                    <input type="radio" name="log" value="Staff">
                                    <span class="checkmark"></span>
                                </label>
								<label class="radio-container m-r-55">Delivery Boy
                                    <input type="radio" name="log" value="Delivery Boy">
                                    <span class="checkmark"></span>
                                </label>
                                <label class="radio-container">Admin
                                    <input type="radio" name="log" value="Admin">
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="Password" name="pass" required>
                                </div>
                            </div>
                        </div>
					...
					<div>
							<a href='fp1.php'>Forgot Password?</a>
                            <!--<button class="btn btn--radius-2 btn--red" name="forgot" onclick="window.location = 'fp1.php'">Forgot Password</button>-->
                    </div>
                </div>
            </div>
        </div>
