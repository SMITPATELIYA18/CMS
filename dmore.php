<?php
	...
	// $sql="select * from consignment where delivery_id=$d_id";
	// $result=mysqli_query($conn,$sql);
	//$conn=mysqli_connect("localhost","root","","courier_system");
    if(isset($_GET['id']))
        $id=$_GET['id'];
    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="active"><a href="dverify.php">Verify-Consgt.</a></li>
...
<div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
				...
				<div class="card-body">
                    <form method="POST" action="ddupdate.php">
                    	<div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input readonly class="input--style-5" type="text" name="price" value="<?php echo $total  ?>">  *   Including GST
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input readonly class="input--style-5" type="date" name="d_date" value="<?php echo $row['delivery_date'];  ?>">
                                </div>
                            </div>
                        </div>
                    	<div align="center">
                    ...
                    <div style="text-align:left;">
                            <button class="btn btn--radius-2 btn--red" name="back" onclick="window.location = 'dpickup.php'">Back </button>
                    </div>
                </div>
            </div>
        </div>
