<?php
	...
	$b_id=$row['branch_id'];
	echo $b_id."  ";
	$sql="select * from consignment where branch_sou_id='$b_id' and verify='Pending' and delivery_id IS NULL ORDER BY s_mode DESC, con_id ASC";
	$result=mysqli_query($conn,$sql);
    ...
    <?php
		...
		while($row=mysqli_fetch_assoc($result))
		{
			echo "<tr>
					...
					<td>".$row['s_mode']."</td>
					<td>".$row['payment']."</td>
					<td><a href='ppverify.php?id=".$row['con_id']."'>Verify</a> | <a href='ppupdate.php?id=".$row['con_id']."'>Update<a></td>
				  </tr>";
		}
		}
		else
