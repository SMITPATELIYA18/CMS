<?php
	...
	$e_id=$row['e_id'];
	$aa=$row['aadhar'];
	$sql="select * from branch_staff where e_id=$e_id";
	$row=mysqli_fetch_assoc(mysqli_query($conn,$sql));
	$job=$row['job_city'];
	$b_id=$row['branch_id'];
    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="active"><a href="pbranchform.php">Job Profile</a></li>
				<li>
...
<div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
				...
				<div class="card-body">
                    <form method="POST" action="pbranchformadd.php">
					<div class="form-row">
					...
					<div class="form-row">
						 ...
						 <div>
                            <button class="btn btn--radius-2 btn--red" type="submit">Apply For Change</button>
                        </div>
                    </form>
                </div>
            </div>
