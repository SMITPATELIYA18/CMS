...
<section class="special-w3layouts">
	<div class="container">
		<h3 class="text-center wthree w3-agileits">Welcome <?php echo $uname; ?></h3>
		...
		<div class="col-lg-4 col-md-3 col-sm-6">
			<a href='consignment1.php'><img src="images/eye1.png" alt="" class="img-responsive"></a>
			<h4 class="text-center">Add Consignment</h4>
			<p class="special-p1">For Add Consignment Click on image.</p>
		</div>
		<div class="col-lg-4 col-md-3 col-sm-6">
			<a href='PriceStore1.php'><img src="images/ruppe1.jpg" alt="" class="img-responsive"></a>
