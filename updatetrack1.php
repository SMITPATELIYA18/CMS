    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="active"><a href="pupdate.php">Update Track</a></li>
...
<div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" action="trackup.php">
						<div class="form-row">
                                ...
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="des">
                                            ...
                                            <option value="Package Arrived ">Package Arrived At</option>
                                            <option value="Package Send To Main Branch ">Package Send To Main Branch</option>
                                            <option value="Package Send To Sub Branch ">Package Send To Sub Branch</option>
                                        </select>
