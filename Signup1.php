    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="active"><a href="Signup1.php" ><i class="fa fa-lock" aria-hidden="true"></i>Signup</a></li>
			</ul>
        </div><!--/.nav-collapse -->
    </div>
</nav>
            ...
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form action='signup.php' method="post">
						...
						<div class="form-row p-t-20">
                            ...
                            <div class="p-t-15">
                                <label class="radio-container m-r-55">Consumer
                                    <input type="radio" checked="checked" name="type" value="Consumer">
								...
								<label class="radio-container m-r-55">Delivery Boy
                                    <input type="radio" name="type" value="Delivery Boy">
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="username" required onchange="validate('uname',this.value)"><div id="uname"></div>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="email" name="email" required  onchange="validate('email',this.value)"><div id="email"></div>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div>
                            <button class="btn btn--radius-2 btn--red" name="submit" type="submit">Signup</button>
                        </div>
                    </form>
                </div>
            </div>
