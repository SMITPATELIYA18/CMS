    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				<li class="active"><a href="dDelivery-Boy.php">Home</a></li>
...
<section class="service-w3ls">
	<div class="container">
		...
		<h3 class="text-center w3-agileits agileits-w3layouts agile w3-agile">Delivery-Boy</h3>
...
<section class="service-agileits"> 
	<div class="container">
		...
		<h3 class="text-center">Delivery-Boy Information</h3>
		<p class="text-center">Delivery boy is to pick up the consignment from the consumer pickup place and give to the near branch office and deliver the consignment.The work of the delivery boy is to add the consignment detail and verify the detail at consumer pickup place.</p>
	</div>
	<div class="container marketing">
		...
		<div class="row featurette">
			<div class="col-md-7">
				...
				<p class="serv-p2">Delivery Boy verify consignment by id The service allows compound operators to validate documents. It is a simple and secure way of checking online that goods have been cleared by customer, allowing them to be released.</p>
			</div>
			<div class="col-md-5 serv-w3layouts">
				<div class="hover01 column">
					<div>
						<figure><img class="featurette-image img-responsive center-block" src="images/h3.jpg" alt="Generic placeholder image"></figure>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row featurette">
			<div class="col-md-7 col-md-push-5">
				<h4 class="featurette-heading">Pick UP-Consignment</h4>
				<p class="serv-p2">Delivery boy see the pick up location and time to Pick up consignment as per Consumer Fill up Form.</p>
			</div>
			<div class="col-md-5 col-md-pull-7">
				<div class="hover01 column">
					<div>
						<figure><img class="featurette-image img-responsive center-block" src="images/h2.jpg" alt="Generic placeholder image"></figure>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row featurette">
			<div class="col-md-7">
				<h4 class="featurette-heading">Deliver Consignment</h4>
				<p class="serv-p2">Whether you’re the one shipping or the one receiving,Delivery-Boy has you covered. Simple, intuitive, worry-free and available in most major markets, it allows everyone to maximize their delivery experience.</p>
			</div>
			<div class="col-md-5 serv-w3layouts">
				<div class="hover01 column">
					<div>
						<figure><img class="featurette-image img-responsive center-block" src="images/h5.jpg" alt="Generic placeholder image"></figure>
					</div>
				</div>
			</div>
		</div>
